...
function DetailTable(props) {
  // context
  const { filterTrademarks } = useContext(TrademarkContext)
    ...
    <>
      <TableContainer sx={tableContainer}>
        <Table stickyHeader sx={tableXS} aria-label='simple table'>
          <TableHead />
          {filterTrademarks?.length ? (
            <TableBody>
              {_.sortBy(filterTrademarks, ['_id'])
                  ...
                  return (
                    <TableRow hover role='checkbox' tabIndex={-1} key={row._id}>
                      ...
                      <TableCell align='left'>
                        <Typography>{row.trademarkingEvent}</Typography>
                      </TableCell>
                      <TableCell align='left'>
                        <Typography>{row.trademarkingEventDate}</Typography>
                      </TableCell>
                      <TableCell align='left'>
